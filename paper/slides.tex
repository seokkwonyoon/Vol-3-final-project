  ...
  \begin{columns}
    ...
    \begin{column}{0.65\textwidth}
      ...
      {\footnotesize
        ...
        Red line: OLS $\widehat{\IC}\approx 0.05$ — nearly flat against the noise.
      }
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Ethical Implications}
  ...
  \begin{block}{3. Societal Brain Drain}
    Quantitative finance aggressively recruits top-tier STEM talent by offering highly competitive compensation. This siphons intellectual capital away from research areas—such as healthcare, engineering, or climate science—that may offer higher tangible benefits to the public.
  \end{block}
\end{frame}
...
\begin{frame}{Conclusions}
  ...
  \vfill
  \centering\small 10 slides total
\end{frame}
